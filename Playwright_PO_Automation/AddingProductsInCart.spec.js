...
test('AddingProductinCart', async ({ page }) => {
    ...
    const productName1 = "IPHONE 13 PRO";
    ...
    // To iteration the title name one by one we need to count the value in  array format by using the .count function and count value we store in one variable as array
    ...
    //await page.getByLabel("Credit Card Number").fill("4542 5599 0012 2293");
    //await page.getByRole('list', {link: 'Credit Card Number'}).fill("4542 5599 0012 2293")
    ...
    //Name of Card
    //await page.locator("[name='Name on Card ']").first().fill("Mike test")
...
//-----------------------section 28 Fetching the oder id and message from Landing screen -----------------------------------------------//
    ...
    // const AddedProduct = await page.locator(".card-body b").locator("b").textContent();
    // console.log("Added Product on Order Review page ", + AddedProduct)
...
//-----------------------------------section 30 find the order id from Order history page--------------------------//
    ...
    // Validate order id on thank you for shopping screen
